    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        ...
        <div>
                ...
                @foreach($options as $index => $option)
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="text"
                               ...
                               class="border border-gray-300 dark:border-gray-700 rounded-lg w-full px-2 py-1 dark:bg-gray-800 dark:text-white">
                        @if($index > 1)
                            <button type="button"
            ...
            <button type="button"
                    ...
                    class="mt-2 text-sm text-blue-600 hover:underline">Add Option</button>
        </div>
